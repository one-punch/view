...
import com.xxshop.pay.alipay.util.AlipayNotify;
import com.xxshop.pay.bill.util.MD5Util;
import com.xxshop.pay.tenpay.RequestHandler;
import com.xxshop.pay.tenpay.ResponseHandler;
...
import org.springframework.web.servlet.ModelAndView;
 ...
 public class PayViewAction
 {
   ...
   private MsgTools msgTools;
	...
	/**
	 * 使用支付宝付款成功后调用返回方法，处理成功后相关业务，如验证交易成功是否，积分扣去，日志记录等
	 * @param request
	 * @param response
	 * @return
	 * @throws Exception
     ...
     throws Exception
   {
     ...
     if (type.equals("goods")) {
      order = this.orderFormService.findByOrderId(order_no);//getObjById(CommUtil.null2Long(order_no));
     }
     if (type.equals("cash")) {
