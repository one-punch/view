...
import org.springframework.web.servlet.ModelAndView;
 ...
 @Controller
 public class InstallViewAction
   implements ServletContextAware
 {
   ...
   public ModelAndView install(HttpServletRequest request, HttpServletResponse response, String install_status, String title, String pws, String test_data)
   {
     ModelAndView mv = new JModelAndView(
       "WEB-INF/templates/install/install1.html", this.configService
       .getSysConfig(), 
   ...
   public ModelAndView install_over(HttpServletRequest request, HttpServletResponse response) {
     ModelAndView mv = new JModelAndView("success.html", this.configService
       ...
       request, response);
     mv.addObject("op_title", "您已经安装XXSHOP商城系统，重新安装请删除install.lock文件");
     return mv;
   }
   ...
   public ModelAndView install_view(HttpServletRequest request, HttpServletResponse response) {
     ModelAndView mv = new JModelAndView(
       "WEB-INF/templates/install/install_view.html", this.configService
       .getSysConfig(), 
       this.userConfigService.getUserConfig(), 2, request, response);
     return mv;
   }
