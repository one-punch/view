 ...
 public class UCViewAction
 {
   ...
   private String uc_answer(HttpServletRequest request, HttpServletResponse response)
   {
     ...
     if (action.equals("gettag")) {
       ...
       if (!API_SYNLOGIN)
         return API_RETURN_FORBIDDEN;
       xxshop_login(request, response, get);
     } else if (action.equals("synlogout")) {
       if (!API_SYNLOGOUT)
         return API_RETURN_FORBIDDEN;
       xxshop_logout(request, response, get); } else {
       if (action.equals("updateclient")) {
         ...
         if (!API_UPDATEPW)
           return API_RETURN_FORBIDDEN;
         xxshop_update_pws(request, response, get);
         return API_RETURN_SUCCEED;
   ...
   protected void xxshop_login(HttpServletRequest request, HttpServletResponse response, Map<String, String> args)
   {
     ...
     if (!admin_login) {
       ...
       String url = CommUtil.getURL(request) + 
         ...
         "xxshop_thid_login_" + password + "&encode=true";
       try {
   ...
   protected void xxshop_logout(HttpServletRequest request, HttpServletResponse response, Map<String, String> args)
   {
     String url = CommUtil.getURL(request) + "/xxshop_logout.htm";
     try {
       response.sendRedirect(url);
     }
     catch (IOException e) {
   ...
   protected void xxshop_update_pws(HttpServletRequest request, HttpServletResponse response, Map<String, String> args)
   {
